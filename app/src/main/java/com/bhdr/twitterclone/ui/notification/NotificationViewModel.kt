...
class NotificationViewModel @Inject constructor(
  ...
  private var notificationListM = MutableLiveData<List<Any>>()
   val notificationList: LiveData<List<Any>> = notificationListM


   private var followedCountM = MutableLiveData<List<Int>>()
   ...
   fun notificationList() {
      viewModelScope.launch {
         notificationListM.value = tweetRepositoryImpl.notificationList()
      }
   }

   private var followedUserM = MutableLiveData<Boolean>()
