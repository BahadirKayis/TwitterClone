...
class RemoteDatabaseImplLOGIN  (private val tweetInterFace: TweetRemoteServiceLOGIN) :
   ...
   override suspend fun getUser(userId: Int): Response<Users> = tweetInterFace.getUser(userId)
